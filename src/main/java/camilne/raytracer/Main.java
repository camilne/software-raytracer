...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        scene.add(new Light(new Vector3f(-2, 6, 6), new Color(0.6f, 1f, 0.7f), 2f));
        scene.add(new Light(new Vector3f(14, 10, 6), new Color(1f, 1f, 1f), 3f));
        scene.add(new Light(new Vector3f(0, 100000, 0), new Color(1f, 1f, 1f), 60000f));

        final var renderOptions = new RenderOptions();
        renderOptions.width = 1280;
        renderOptions.height = 720;
        renderOptions.aa = 2;
